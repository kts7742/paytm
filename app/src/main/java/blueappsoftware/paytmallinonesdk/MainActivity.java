...
public class MainActivity extends AppCompatActivity {
    ...
    private String midString ="MnNIIc39536079546102", txnAmountString="", orderIdString="", txnTokenString="";
...
// nextInt as provided by Random is exclusive of the top value so you need to add 1
    ...
    public void startPaytmPayment (String token){
       ...
       // String host = "https://securegw-stage.paytm.in/order/status";
        String orderDetails = "MID: " + midString + ", OrderId: " + orderIdString + ", TxnToken: " + txnTokenString
                + ", Amount: " + txnAmountString;
        Log.e(TAG, "order details "+ orderDetails);

        String callBackUrl = host + "theia/api/v1/initiateTransaction?mid=" + midString + "&orderId=" + orderIdString;
